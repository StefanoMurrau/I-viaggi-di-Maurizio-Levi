...
//        }
    ...
    $NumAdulti = 2;
    $NumBambini = 2;
    $UlterioriRichieste =  'Test Grassi' ;
    $datapartenza = "49431";
    ...
    $partenza_individuale = 0;
    if($partenza_individuale){
        $datadaBASE = "2023-08-10";
        $dataaBASE = "2023-08-20"; 
        $descrizioneViaggio = " ";
    ...
    $body .= "<br>Per aver richiesto .....  " .$ReqSubjet ;
    $body .= "<br>BLA BLA BLA.";
    $body .= "<br><br> Grazie dal Team di I Viaggi di Maurizio Levi! ";
    $body .= "<br><br> ";
    ...
    require '/home/customer/www/staging-levi.therebelwatchtower.info/public_html/vendor/PHPMailer/src/Exception.php';
    require '/home/customer/www/staging-levi.therebelwatchtower.info/public_html/vendor/PHPMailer/src/PHPMailer.php';
    require '/home/customer/www/staging-levi.therebelwatchtower.info/public_html/vendor/PHPMailer/src/SMTP.php'; 
